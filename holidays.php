...
<nav class="navbar navbar-dark bg-dark main-dashboard-cip other-pages">
    ...
    <div class="form-inline my-2 my-lg-0">
        <button class="btn btn-outline-success my-2 my-sm-0" data-toggle="modal" data-target="#add-holiday-modal"><i
                    class="fas fa-plus"
                    aria-hidden="true"></i>&nbsp;<?php esc_html_e(' Añadir Vacaciones', CIP_FREE_TXTDM); ?></button>&nbsp;&nbsp;
...
<div class="other-page-content">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item" role="presentation" class="active sm-labels nav-item"><a class="nav-link active"
                                                                                      href="#official-holiday"
                                                                                      aria-controls="official-holiday"
                                                                                      role="tab"
                                                                                      data-toggle="tab"><?php esc_html_e('Vacaciones', CIP_FREE_TXTDM); ?></a>
        </li>
    </ul>
                            ...
                            foreach ($holidays as $key => $holiday) {
                                ...
                                if ($holiday['start_date'] == $row_date) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info" title="View" data-toggle="modal"
                                               data-target="#view-holiday-modal"
                                               onclick="return DoAction('view', '<?php echo esc_attr($key); ?>');"><i
                                                        class="fas fa-eye" aria-hidden="true"></i></a>
                                            <a href="#" class="btn btn-info" title="Update" data-toggle="modal"
                                               data-target="#update-holiday-modal"
                                               onclick="return DoAction('update', '<?php echo esc_attr($key); ?>');"><i
                                                        class="fas fa-edit" aria-hidden="true"></i></a>
                                            <a href="#" class="btn btn-info" title="Delete" data-toggle="modal"
                                               data-target="#delete-holiday-modal"
                                               onclick="return DoAction('delete', '<?php echo esc_attr($key); ?>');"><i
            ...
            <form id="add-holiday-form" name="add-holiday-form" method="post" action="">
                <div class="modal-header">
                    <h4 class="modal-title"
                        id="myModalLabel"><?php esc_html_e('Crear Vacaciones', CIP_FREE_TXTDM); ?></h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="input" class="form-control" id="name" name="name" placeholder="Type Holiday Name"
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="input" class="form-control sdate" id="start_date" name="start_date"
                               placeholder="(Formato YYYY-MM-DD)" required>
                    </div>

                    <div class="form-group">
                        <label for="end_date"><?php esc_html_e('Finalización', CIP_FREE_TXTDM); ?></label>
                        <input type="input" class="form-control edate" id="end_date" name="end_date"
                               placeholder="(Formato YYYY-MM-DD)" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <input type="submit" id="add-holiday-button" name="add-holiday-button" class="btn btn-success"
                           value="Añadir">
                    <button type="button" id="add-holiday-close" name="add-holiday-close" class="btn btn-danger"
                            data-dismiss="modal">Cerrar
                    </button>
                    <div id="add-loading-icon" style="display:none;">
                        <?php esc_html_e('Procesando...', CIP_FREE_TXTDM); ?><i class="fas fa-spinner fa-3x"
                                                                                aria-hidden="true"></i>
                    </div>
                </div>
            </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="view-holiday-form" name="view-holiday-form">
                <div class="modal-header">
                    <h4 class="modal-title"
                        id="myModalLabel"><?php esc_html_e('Información de las vacaciones', CIP_FREE_TXTDM); ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body" id="view-modal-body">
                    <div id="view-loading-icon" style="display:none;">
                        <?php esc_html_e('Processing...', CIP_FREE_TXTDM); ?><i class="fas fa-spinner fa-3x"
                                                                                aria-hidden="true"></i>
                    </div>
                    <tr>
                        <td>
                            <label for="AffectedUsers"><strong><?php esc_html_e('Usuarios asignados: ', CIP_FREE_TXDM );?></strong></label>
                        </td>
                        <br>
                        <td>
                            <?php
                            if ( isset($holiday['user_ids']) && !empty($holiday['user_ids']) ) {
                                $user_names = array();
                                foreach ($holiday['user_ids'] as $uid) {
                                    $user_obj = get_userdata($uid);
                                    if ($user_obj) {
                                        $user_names[] = $user_obj->display_name;
                                    }
                                }
                                echo esc_html(implode(', ', $user_names));
                            } else {
                                esc_html_e('Ninguno', CIP_FREE_TXTDM);
                            }
                            ?>
                        </td>
                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="update-holiday-form" name="update-holiday-form">
                <div class="modal-header">
                    <h4 class="modal-title"
                        id="myModalLabel"><?php esc_html_e('Update Holiday Details', CIP_FREE_TXTDM); ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body" id="update-modal-body">
                    ...
                    <tr>
                        <td>
                            <label for="update_user_ids"><?php esc_html_e('Usuarios asignados', CIP_FREE_TXTDM ); ?></label>
                        </td>
                        <td>
                            <select id="update_user_ids" name="user_ids[]" class="form-control" multiple>
                                <?php
                                // Retrieve users with the appropriate role (or adjust roles as needed)
                                $users = get_users(array('role' => 'author'));
                                // Get the current selected users from the holiday record (if any)
                                $selected_users = isset($holiday['user_ids']) ? $holiday['user_ids'] : array();
                                foreach ($users as $user) {
                ...
                <div class="modal-footer">
                    <button type="button" id="update-holiday-button" name="update-holiday-button"
                            class="btn btn-success"
                            onclick="return DoAction('update-now', '');"><?php esc_html_e('Update Holiday', CIP_FREE_TXTDM); ?></button>
                    <button type="button" id="update-holiday-close" name="update-holiday-close" class="btn btn-danger"
        ...
        <div id="view-holiday-result">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><?php if ($status == 1) esc_html_e("Pending");
                        if ($status == 2) esc_html_e("Approved");
                        if ($status == 3) esc_html_e("Cancelled"); ?></td>
                </tr>
            </table>
        </div>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="input" class="form-control" id="holiday_name" name="name"
                               placeholder="Nombre de las vacaciones" value="<?php echo esc_attr($name); ?>">
                        <div class="required"
                             style="display:none; color:red"><?php esc_html_e('Required field.', CIP_FREE_TXTDM); ?></div>
                ...
                <tr>
                    ...
                    <td>
                        <input type="input" class="form-control sdate" id="start_dates" name="start_date"
                               placeholder="Start Date (Use Format YYYY-MM-DD)"
                ...
                <tr>
                    ...
                    <td>
                        <input type="input" class="form-control edate" id="end_dates" name="end_date"
                               placeholder="End Date (Use Format YYYY-MM-DD)"
